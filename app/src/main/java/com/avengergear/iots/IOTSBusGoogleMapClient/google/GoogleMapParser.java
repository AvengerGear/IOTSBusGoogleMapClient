...
import com.avengergear.iots.IOTSBusGoogleMapClient.parser.MapParser;
...
public class GoogleMapParser extends JSONParser implements MapParser {
    /**
     * Distance covered. *
     */
    private int distance;

    public GoogleMapParser(String feedUrl) {
        super(feedUrl);
    }
